...
import filterData from "../../../../../services/HelperProvider";
...
const ProvidersOrdersDataTable = ({ orders }: IOProps) => {
  ...
  const columns = [
    ...
    //   title: "Details",
    //   key: "details",
    //   render: (_text:any, record: any) => <Button type='primary' onViewOrder(record)}}>Voir</Button>,
    // },
  ];
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      ...
      <div ref={ref} style={{ height: "100%", overflow: "auto" }}>
        <Table dataSource={filteredData} columns={columns} scroll={{ y: tableHeight, x: 500 }} pagination={false} />
      </div>
    </div>
  );
};

export default ProvidersOrdersDataTable;
