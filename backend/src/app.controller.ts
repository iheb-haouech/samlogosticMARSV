...
import { ResponseDto, StatisticsDTO } from './utils/response.dto';
...
export class AppController {
  ...
  async getAllCompanyTypes() {
    return this.appService.getAllCompanyTypes();
  }
  ...
  async getAllCompanyActivities() {
    return this.appService.getAllCompanyActivities();
  }
  ...
  async getAllCarTypes() {
    return this.appService.getAllCarTypes();
  }
