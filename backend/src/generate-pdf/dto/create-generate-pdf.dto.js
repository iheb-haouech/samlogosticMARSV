...
exports.CreateGeneratePdfDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var CreateGeneratePdfDto = function () {
    var _a;
    var _instanceExtraInitializers = [];
    var _orderId_decorators;
    var _orderId_initializers = [];
    return _a = /** @class */ (function () {
            function CreateGeneratePdfDto() {
                this.orderId = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _orderId_initializers, void 0));
            }
            return CreateGeneratePdfDto;
        }()),
        (function () {
...
exports.CreateGeneratePdfDto = CreateGeneratePdfDto;
