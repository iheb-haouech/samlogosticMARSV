...
var ArticleController = function () {
    var _classDecorators = [(0, common_1.Controller)('article')];
    ...
    var ArticleController = _classThis = /** @class */ (function () {
        function ArticleController_1(articleService) {
            this.articleService = (__runInitializers(this, _instanceExtraInitializers), articleService);
        }
        ArticleController_1.prototype.create = function () {
    ...
    (function () {
        ...
        _create_decorators = [(0, common_1.Get)()];
