...
exports.InitCompanyActivities = void 0;
var InitCompanyActivities = function (prismaClient) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prismaClient.company_activity.upsert({
                    where: { id: 1 },
                    update: {},
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, prismaClient.company_activity.upsert({
                        where: { id: 2 },
                        update: {},
                        create: {
                            id: 2,
...
exports.InitCompanyActivities = InitCompanyActivities;
