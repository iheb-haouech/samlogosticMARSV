...
TAR = r'C:\Users\Administrateur\AppData\Local\Temp\SamLogisticApp4.tar'
...
sftp = ssh.open_sftp()
sftp.put(TAR, '/tmp/SamLogisticApp4.tar')
sftp.close()

stdin, stdout, stderr = ssh.exec_command('rm -rf /opt/SamLogisticApp && mkdir -p /opt && tar -xf /tmp/SamLogisticApp4.tar -C /opt/ && rm /tmp/SamLogisticApp4.tar')
stdout.read()
